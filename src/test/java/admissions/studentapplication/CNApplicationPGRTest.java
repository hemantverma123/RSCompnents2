...
public class CNApplicationPGRTest {
	...
	public void test() throws IOException {
		...
		newApplication.SelectCampus().ClickNextBtn().SelectInternational("No").ClickNextBtn().SelectCourseLvl(courseLvl)
				...
				.SelectAlternative(false).ClickNextBtn().SelectUkStudy(false).ClickNextBtn().ClickConfirmSelectionBtn();
		...
		suppDocs.selectReasonForNotProviding(1).saveBtn().submitAppBtn();
		...
		appSummary.getScreenShot("CNApplicationPGRest");
