...
public class CNApplicationPGTTest {
	...
	public void test() throws IOException {
		...
		newApplication.SelectCampus().ClickNextBtn().SelectInternational("No").ClickNextBtn()
				...
				.ClickNextBtn().SelectFullTime(true).ClickNextBtn()//.SelectAlternative(false).ClickNextBtn().SelectUkStudy(false).ClickNextBtn()   //todo changed by HV
		...
		appSummary.getScreenShot("CNApplicationPGTest");
