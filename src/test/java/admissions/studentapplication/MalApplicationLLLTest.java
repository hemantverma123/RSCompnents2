...
public class MalApplicationLLLTest {
	...
	public void test() throws IOException {
		...
		newApplication.SelectCampus().ClickNextBtn().SelectInternational("No").ClickNextBtn().SelectCourseLvl(courseLvl)
				...
				.SelectFullTime(true).ClickNextBtn().finalCourse().ClickNextBtn() // year of Entry is all ready pre-populated so can
		...
		appSummary.getScreenShot("MalApplicationLLLTest");
