...
public class MalApplicationPGTTest {
	...
	public void setUp() throws Exception {
		...
		studentData = TestManager.getStudentData(countryCode);  //TODO HVDec12
	...
	public void test() throws IOException {
		...
		perStatement.careerObjectives().majorStrengths().whyNow().managingTeams().budgets()
		...
		appSummary.getScreenShot("MalApplicationPGTTest");
